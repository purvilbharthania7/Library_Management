...
<span>Author Name</span><input type="text" name="authorname" id="re"/>
<span>Department</span><input type="text" name="dept" id="re"/>
<span>Semester</span><input type="text" name="sem" id="re"/>
<span>Edition</span><input type="text" name="edition" id="re"/>
<span>Qauntity</span><input type="text" name="qauntity" id="re"/>
